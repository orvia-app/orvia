        ...
        {themeOptions.map(({ value, label, icon: Icon }) => {
          ...
          return (
            <button
              ...
              className={
                active
                  ? "flex items-center gap-2 rounded-xl bg-zinc-900 px-3 py-2.5 text-left text-sm font-medium text-white dark:bg-zinc-800 dark:text-white"
                  : "flex items-center gap-2 rounded-xl px-3 py-2.5 text-left text-sm font-medium text-zinc-600 transition hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-900 dark:hover:text-white"
              }
            >
  ...
  return (
    <div className="flex min-h-screen bg-zinc-50 text-zinc-950 dark:bg-black dark:text-white">
      <aside className="hidden w-72 shrink-0 flex-col border-r border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950 lg:flex">
        ...
        <nav
          className="mt-10 flex flex-1 flex-col gap-1 overflow-y-auto"
          aria-label="Main"
        >
          {navItems.map(({ label, href, icon: Icon }) => {
            ...
            return (
              <Link
                ...
                className={
                  active
                    ? "flex items-center gap-3 rounded-xl bg-zinc-900 px-4 py-3 text-sm font-medium text-white dark:bg-zinc-800 dark:text-white"
                    : "flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-zinc-600 transition hover:bg-zinc-100 hover:text-zinc-950 dark:text-zinc-400 dark:hover:bg-zinc-900 dark:hover:text-white"
                }
              >
      ...
      <div className="flex min-h-screen flex-1 flex-col bg-zinc-50 dark:bg-black">
        <header className="border-b border-zinc-200 bg-white px-6 py-4 dark:border-zinc-800 dark:bg-black lg:hidden">
