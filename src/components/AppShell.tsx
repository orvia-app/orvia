...
function LanguageSwitcher() {
  ...
  return (
    <div
      ...
      className="inline-grid grid-cols-2 rounded-full bg-zinc-100 p-0.5 ring-1 ring-zinc-200/75 dark:bg-zinc-950/55 dark:ring-zinc-800/75"
      role="group"
    >
        {(["en", "ua"] as const).map((option) => {
          ...
          return (
            <button
              ...
              className={
                active
                  ? "flex h-6 cursor-pointer items-center justify-center rounded-full bg-white px-2 text-[10px] font-semibold text-violet-800 shadow-sm shadow-zinc-950/[0.035] dark:bg-violet-500/15 dark:text-violet-200 dark:shadow-none"
                  : "flex h-6 cursor-pointer items-center justify-center rounded-full px-2 text-[10px] font-medium text-zinc-500 transition hover:text-violet-700 dark:text-zinc-500 dark:hover:text-violet-200"
              }
            >
              {option === "en" ? "EN" : "UA"}
            </button>
...
function NavLinkItem({
  ...
  const linkClassName = active
    ? [
        "group flex cursor-pointer items-center gap-3 rounded-xl border border-violet-200/75 bg-white px-3 text-sm font-medium text-violet-950 shadow-sm shadow-zinc-950/[0.035] dark:border-violet-500/25 dark:bg-violet-500/10 dark:text-violet-100 dark:shadow-none",
        minHeight ? "min-h-11" : "py-2.5",
      ].join(" ")
    : [
        "group flex cursor-pointer items-center gap-3 rounded-xl border border-transparent px-3 text-sm font-medium text-zinc-600 transition hover:border-zinc-200/80 hover:bg-white/80 hover:text-zinc-950 hover:shadow-sm hover:shadow-zinc-950/[0.02] dark:text-zinc-400 dark:hover:border-zinc-800/90 dark:hover:bg-zinc-900/75 dark:hover:text-white dark:hover:shadow-none",
        minHeight ? "min-h-11" : "py-2.5",
      ].join(" ");
...
function FeedbackLink({
  ...
  return (
    <button
      ...
      className={[
        "w-full text-left",
        "group flex cursor-pointer items-center gap-3 rounded-xl border border-transparent px-3 text-sm font-medium text-zinc-500 transition hover:border-zinc-200/80 hover:bg-white/80 hover:text-zinc-950 hover:shadow-sm hover:shadow-zinc-950/[0.02] dark:text-zinc-500 dark:hover:border-zinc-800/90 dark:hover:bg-zinc-900/75 dark:hover:text-white dark:hover:shadow-none",
  ...
  return (
    <div className={mobile ? "mt-3" : "mt-2"}>
      <button
        ...
        className={
          mobile
            ? "flex min-h-11 w-full cursor-pointer items-center justify-between rounded-xl border border-transparent px-3 text-left text-sm font-medium text-zinc-600 transition hover:border-zinc-200/80 hover:bg-white/80 hover:text-zinc-950 dark:text-zinc-400 dark:hover:border-zinc-800/90 dark:hover:bg-zinc-900/75 dark:hover:text-white"
            : "flex w-full cursor-pointer items-center justify-between rounded-xl border border-transparent px-3 py-2.5 text-left text-sm font-medium text-zinc-500 transition hover:border-zinc-200/80 hover:bg-white/80 hover:text-zinc-950 dark:text-zinc-500 dark:hover:border-zinc-800/90 dark:hover:bg-zinc-900/75 dark:hover:text-white"
        }
      >
        <span>
          {t("nav.labs")}
...
function AuthStatus() {
  ...
  if (isAuthenticated) {
    return (
      <div className="rounded-xl bg-white/70 p-3 shadow-sm shadow-zinc-950/[0.025] ring-1 ring-zinc-200/75 dark:bg-zinc-900/45 dark:shadow-none dark:ring-zinc-800/75">
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0 flex-1">
            <p className="truncate text-xs font-semibold text-zinc-900 dark:text-zinc-100">
              {user?.email ?? t("auth.signedIn")}
            </p>
            <p className="mt-1 truncate text-[10px] leading-4 text-zinc-500 dark:text-zinc-500">
        ...
        <div className="mt-2.5 flex items-center justify-between gap-2 border-t border-zinc-200/70 pt-2.5 dark:border-zinc-800/70">
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-zinc-100 text-zinc-950 dark:bg-zinc-950 dark:text-white">
      ...
      <aside className="sticky top-0 hidden h-screen w-64 shrink-0 flex-col border-r border-zinc-200/80 bg-zinc-50/95 dark:border-zinc-800/80 dark:bg-zinc-950 lg:flex">
        ...
        <div className="shrink-0 border-t border-zinc-200/80 bg-zinc-50/95 px-4 pb-5 pt-4 dark:border-zinc-800/80 dark:bg-zinc-950">
          <button
            type="button"
